...
| `opencli 1688 image-search <image-url-or-file> --limit <n>` | Search matching products using a remote or local product image |
...
# Search matching products by image URL or local file
opencli 1688 image-search "https://example.com/product.webp" --limit 10 -f json
opencli 1688 image-search ./product.jpg --limit 10 -f json
